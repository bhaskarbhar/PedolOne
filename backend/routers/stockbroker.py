...
from routers.policy import create_policy
...
async def stockbroker_verify_otp(data: StockbrokerVerifyOtpRequest):
    ...
    for pii in session["pii"]:
        ...
        policy_result = create_policy(policy_input, user_id=session["user_id"], contract_override=contract)
